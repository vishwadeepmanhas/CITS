...
public class DynamicObject extends Command {
    ...
    private void setProperty(String key, String value) {
    	if(!AutomationObject.dynamicValue.containsKey(userData.getTestCase())) {
    		 Map<String,Map<String, Map<String, String>>> refmap = new HashMap<>();
    		 Map<String, Map<String, String>> Object = new HashMap<>();
             Map<String, String> property = new HashMap<>();
             property.put(key, value);
             Object.put(ObjectName, property);
             refmap.put(Reference, Object);
             AutomationObject.dynamicValue.put(userData.getTestCase(), refmap);
    	}
    		
        if (!AutomationObject.dynamicValue.get(userData.getTestCase()).containsKey(Reference)) {
            Map<String, Map<String, String>> Object = new HashMap<>();
            Map<String, String> property = new HashMap<>();
            property.put(key, value);
            Object.put(ObjectName, property);
            AutomationObject.dynamicValue.get(userData.getTestCase()).put(Reference, Object);
        } else if (!AutomationObject.dynamicValue.get(userData.getTestCase()).get(Reference).containsKey(ObjectName)) {
            Map<String, String> property = new HashMap<>();
            property.put(key, value);
            AutomationObject.dynamicValue.get(userData.getTestCase()).get(Reference).put(ObjectName, property);
        } else {
            AutomationObject.dynamicValue.get(userData.getTestCase()).get(Reference).get(ObjectName).put(key, value);
        }
    }
}
